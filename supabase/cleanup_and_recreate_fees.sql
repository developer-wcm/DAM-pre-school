-- Step 1: Delete all existing fees for DEMO01 school
DELETE FROM fees WHERE school_id = 'DEMO01';

-- Step 2: Recreate fees with correct installments
DO $$
DECLARE
  student_rec RECORD;
  annual_fee NUMERIC;
...
BEGIN
  ...
  RAISE NOTICE '✓ Fee installments created successfully!';
END $$;
